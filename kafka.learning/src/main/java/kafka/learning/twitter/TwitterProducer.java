...
public class TwitterProducer {
    ...
    public TwitterProducer(String apiConsumerKey, String apiConsumerSecret, String token, String secret) {
    ...
    public static void main(String[] args) {
        if (args == null || args.length != 4) {
            throw new IllegalArgumentException(TwitterProducer.class + " must be started providing arguments; apiConsumerKey, apiConsumerSecret, token and secret");
        }
        ...
        new TwitterProducer(apiConsumerKey, apiConsumerSecret, token, secret).run();
    }
